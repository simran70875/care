...
const DUMMY_CARER_DATA: BaseUser[] = [
  ...
  },
  {
    ...
    "address": "Apartment 27, 34 Hulme Hight Street, M15 5JS, Manchester, M15 5JS",
    "phone": "07494267469",
    "isActive": "Activated",
    "schedule": "Y",
    "details": "",
  ...
  },
  {
    ...
    "userId": "CA1009",
    "name": "Ilhamo  Ahmed",
    "address": "71 Randolph Street, Levenshulme, Moss Side   Manchester,, Lancashire, M19 3BW",
    "phone": "07548860356",
    "isActive": "Activated",
    "schedule": "Y",
    "details": "",
  ...
  },
  {
    ...
    "userId": "CA1063",
    "name": "Yetunde Rahmon",
    "address": "Flat 1, 246 Weaste Lane, Salford, M5-5HF, MANCHESTER, LANCASHIRE, M5-5HF",
    "phone": "07780995189",
    "isActive": "Activated",
    "schedule": "Y",
    "details": "",
  ...
  },
  {
    ...
    "userId": "CA1069",
    "name": "Sarah Sharman",
    "address": "18 Trent Bridge Walk Old Trafford, Manchester, Lancashire, M16 0JR",
    "phone": "07759800948",
    "isActive": "Activated",
    "schedule": "Y",
    "details": "",
...
export default function CarersPage() {
  ...
  const activeCarers = DUMMY_CARER_DATA.filter(c => c.isActive === "Activated");
  const pendingCarers = DUMMY_CARER_DATA.filter(c => c.isActive === "Not Activated");
  ...
  const archivedCarers: BaseUser[] = [
    ...
    },
    {
      "_id": "2415",
      "name": "Amina Abdella",
      "address": "1 Backwell Street, Manchester, Greater Manchester, M11 1EZ, M11 1EZ",
      "phone": "07961016924",
    ...
    },
    {
      "_id": "2459",
      "name": "Amir Abdullah",
      "address": "44 Maher Gardens, M15 5PW, Manchester, Manchester, England, M15 5PW",
      "phone": "07765647347",
      "email": "",
      "isActive": "Archived",
      "position": "Care Worker",
    ...
    },
    {
      "_id": "2362",
      "name": "Asif Ali",
      "address": "14 Derbyshire Crescent, Stretford, Manchester, Lancashire, M32 9LG",
      "phone": "07446652348",
    ...
    },
    {
      "_id": "2417",
      "name": "Zahra  Ali",
      "address": "17 South Street, Longsight, Manchester, Greater Manchester, M12 4PN, M12 4PN",
      "phone": "07875328381",
      "email": "",
      "isActive": "Archived",
      "position": "Care Worker",
    ...
    },
    {
      "_id": "2450",
      "name": "Muhammad Azhar",
      "address": "20 St.Brannocks Road, Chorlton, Manchester, Lancashire, M21 0UP",
      "phone": "07487388482",
    ...
    },
    {
      ...
      "address": "1G Selworthy Road, Manchester, Greater Manchester, M16 7UG, M16 7UG",
      "phone": "07514120690",
    ...
    },
    {
      "_id": "2420",
      "name": "Hodan Dahir",
      "address": "28 ROSEBERY STREET, Manchester, GREATER MANCHESTER, M14 4UR, m14 4UR",
    ...
    },
    {
      ...
      "address": "Flat 2 Royston Court, Carlton Road, Manchester, County, M16 8LN",
      "phone": "07312518738",
      "email": "",
      "isActive": "End of Service",
      "position": "Care Worker",
    ...
    },
    {
      ...
      "address": "Flat 1, 492 Liverpool Road, Eccles, M30 7HZ, Manchester, M30 7HZ",
      "phone": "07546663855",
      "email": "",
      "isActive": "End of Service",
      "position": "Care Worker",
    ...
    },
    {
      ...
      "address": "Block C Flat 23 Orlando Village, Thynne Street, BL3 6BA, Bolton, Bl3 6BA",
      "phone": "07771117091",
      "email": "",
      "isActive": "Archived",
      "position": "Care Worker",
    ...
    },
    {
      "_id": "2426",
      "name": "Fatima Omar",
      "address": "96 Harington Street, Manchester, Greater Manchester, M14 4RQ, M14 4RQ",
      "phone": "07481246026",
    ...
    },
    {
      "_id": "2429",
      "name": "Mina Pazoki",
      "address": "6 Assisi Gardens, Manchester, Greater Manchester, M12 5AS, M12 5AS",
      "phone": "07846733336",
      "email": "",
      "isActive": "Archived",
      "position": "Care Worker",
    ...
    },
    {
      "_id": "2551",
      "name": "Arfa Qaiser",
      "address": "Apartment 23c Wilbraham Court, 16-18 Wilbraham Road, Manchester, Lancashire, M14 6JY",
      "phone": "07312193537",
      "email": "",
      "isActive": "Archived",
      "position": "Care Worker",
    ...
    },
    {
      "_id": "9",
      "name": "Nazia Raja",
      "address": "7 Orchard Cresent, Sockport, Cheshire, Manchester, Lancashire, SK10 4TZ",
      "phone": "07940936266",
    ...
    },
    {
      "_id": "2430",
      "name": "Amal Sheek",
      "address": "23 Westman Drive, Manchester, Greater Manchester, M13 9ES, M13 9ES",
      "phone": "07760466329",
  ...
  const [changePasswordCarer, setChangePasswordCarer] = useState<BaseUser | null>(
    null
  );
  ...
  const handlePasswordChange = async () => {
    ...
    toast.success(
      `Password for ${changePasswordCarer?.name} changed (mocked)`
    );
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Edit Carer Modal (Fields changed from Agent to Carer) */}
      <CommonModal
        open={!!editCarer}
      ...
      {/* Add New Carer Modal (Fields changed from Agent to Carer) */}
      <CommonModal
      ...
      {/* change password modal (Fields changed from Agent to Carer) */}
      <CommonModal
      ...
      {/* Confirm Delete Modal (Fields changed from Agent to Carer) */}
      <ConfirmModal
        open={!!deleteCarer}
