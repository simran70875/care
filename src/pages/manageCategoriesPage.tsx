                    ...
                    >
                        ...
                        >
                            <div className="w-12 h-12 shrink-0 rounded-full overflow-hidden border border-gray-300 dark:border-gray-600">
                                ...
                                {
                                    categoryType === "child" ? <div className="w-full h-full object-cover bg-blue-300 flex items-center justify-center uppercase text-xl">{cat.Category3 ? cat.Category3[0] : ""} </div> :
                                        <img
